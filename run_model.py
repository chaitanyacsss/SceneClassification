...
def main(checkpoint_folder='checkpoints/', test_sample=None):
    ...
    if not model_conv:
        ...
        if not test_sample:
            _, _, test_loader = get_data_loaders(input_dir="images/", batch_size=10, num_workers=6, val_size=200,
                                                 test_size=200)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--image', default=None, type=str,
                        help='file path to the image to be predicted (default: None/); if None, gives accuracy on the test set')
    parser.add_argument('-f', '--checkpoints', default=None, type=str,
                        help='folder path for checkpoints (default: checkpoints/)')
