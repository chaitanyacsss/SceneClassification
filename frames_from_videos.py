...
import argparse
import logging
logging.basicConfig(filename="logs/frames_from_videos.log",filemode='a', format='%(asctime)s,%(msecs)d %(name)s %(levelname)s %(message)s', datefmt='%H:%M:%S', level=logging.DEBUG)
...
if __name__ == '__main__':
	...
	parser.add_argument('-d', '--frameDistance', default=250, type=int,help='Number of frames to skip between two saves')
